...
class ControllerExtensionModuleShipstation extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/shipstation', 'user_token=' . $this->session->data['user_token'], 'SSL')
        );
        $data['action'] = $this->url->link('extension/module/shipstation', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['keygen'] = $this->url->link('extension/module/shipstation/keygen', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['clear'] = $this->url->link('extension/module/shipstation/clear', 'user_token=' . $this->session->data['user_token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('extension/module/shipstation', $data));
    }
    ...
    public function keygen() {
        ...
        $this->response->redirect($this->url->link('extension/module/shipstation', 'user_token=' . $this->session->data['user_token'], 'SSL'));
    }
