...
if (strpos('x'.$id, 'Product') != false)
	...
	$query = $db->query("delete from " . DB_PREFIX . "seo_url where query = 'product_id=$id';");
	$query = $db->query("insert into " . DB_PREFIX . "seo_url(query, keyword) values('product_id=$id','$keyword');");
...
if (strpos('x'.$id, 'Category') != false)
	...
	$query = $db->query("delete from " . DB_PREFIX . "seo_url where query = 'category_id=$id';");
	$query = $db->query("insert into " . DB_PREFIX . "seo_url(query, keyword) values('category_id=$id','$keyword');");
...
if (strpos('x'.$id, 'Information') != false)
	...
	$query = $db->query("delete from " . DB_PREFIX . "seo_url where query = 'information_id=$id';");
	$query = $db->query("insert into " . DB_PREFIX . "seo_url(query, keyword) values('information_id=$id','$keyword');");
...
if (strpos('x'.$id, 'Manufacturer') != false)
	...
	$query = $db->query("delete from " . DB_PREFIX . "seo_url where query = 'manufacturer_id=$id';");
	$query = $db->query("insert into " . DB_PREFIX . "seo_url(query, keyword) values('manufacturer_id=$id','$keyword');");
