...
if ((!isset($_GET['gkey'])) || ($_GET['gkey'] != $parameters['gkey'])) 	{
		...
		foreach ($query->rows as $product) {
			...
			$db->query("update " . DB_PREFIX . "product_description_seo set custom_h2 = '". htmlspecialchars($ch2s) ."' where product_id = ".$product['product_id']." and language_id = ".$product['language_id'].";");			
